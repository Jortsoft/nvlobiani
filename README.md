...
| 📝 Comment / Uncomment code | `<leader>space + /`              |
| 📝 Fix git conflicts        | `<leader>space + G`              |
| 📝 Edit file or folder      | `<leader>space + J`              |
...
|  ☾ Dark theme         | `:Theme githubdark`                    |
| ☀️ Light theme        | `:Theme onelight`                      |
| 🔄 Reload vim         | `:Reload`                              |
| 🧑🏻‍💻 Set LTS            | `:SetLanguage angular, vue, unity`     |
